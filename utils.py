...
def build_absolute_url(href: str, base_url: str) -> str:
    # Construye la URL absoluta combinando el href con la base_url utilizando urljoin
    absolute = urljoin(base_url, href)
    # Para manejar caracteres especiales en la URL, desmontamos la URL y codificamos solo la parte de la ruta
    parsed = urlparse(absolute)
    # Codifica la parte de la ruta de la URL para manejar caracteres especiales, dejando los caracteres "/" sin codificar
    encoded_path = quote(parsed.path, safe="/")
    # Reconstruye la URL con la ruta codificada y devuelve la URL absoluta final
